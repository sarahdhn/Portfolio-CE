...
function minnak_site_copyright() {
	...
	if ( empty( $minnak_custom_copyright_textarea ) ) :
		$html  = '<span id="copyright-text-area"> ' . '<a href="' . esc_url( 'https://wordpress.org/' ) . '">' . esc_html( __( 'Proudly powered by WordPress', 'minnak' ) ) . '</a>' . '<span class="sep"> - </span>' . esc_html( __( 'Copyright', 'minnak' ) ) . ' ' . minnak_auto_copyright() . '</span>';
		echo wp_kses(
			$html,
			array(
				'a'  => array(

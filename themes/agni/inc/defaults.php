...
if ( ! function_exists( 'lalita_get_color_defaults' ) ) {
	...
	function lalita_get_color_defaults() {
		$lalita_color_defaults = array(
			...
			'content_title_color' => '',
			'blog_header_bg_color' => '#fee5ee',
			'blog_header_bg_s_color' => 'rgba(255,255,255,0)',
			'blog_header_title_color' => '#f33333',
			'blog_header_text_color' => '#ffffff',
			'blog_header_button' => '#fee5ee',
			'blog_header_button_bg' => 'rgba(243,51,51,0)',
			'blog_header_button_hover' => '#fee5ee',
			'blog_header_button_hover_bg' => 'rgba(243,51,51,0)',
			...
			'h5_color' => '',
			'h6_color' => '',
			'sidebar_widget_background_color' => '#fee5ee',
			'sidebar_widget_text_color' => '#333333',
			'sidebar_widget_link_color' => '#f33333',
			'sidebar_widget_link_hover_color' => '#333333',
			'sidebar_widget_title_color' => '#f33333',
			'footer_widget_background_color' => '#fee5ee',
			'footer_widget_text_color' => '#333333',
			'footer_widget_link_color' => '#f33333',
			'footer_widget_link_hover_color' => '#333333',
			'footer_widget_title_color' => '#f33333',
			'footer_background_color' => '#fee5ee',
			'footer_text_color' => '#333333',
			'footer_link_color' => '#f33333',
			'footer_link_hover_color' => '#333333',
			'form_background_color' => '#fee5ee',
			'form_text_color' => '#333333',
			'form_background_color_focus' => '#f33333',
			'form_text_color_focus' => '#ffffff',
			'form_border_color' => '#111111',
			'form_border_color_focus' => '#111111',
			'form_button_background_color' => '#fee5ee',
			'form_button_background_color_hover' => '#fee5ee',
			'form_button_text_color' => '#f33333',
			'form_button_text_color_hover' => '#f33333',
			'back_to_top_background_color' => 'rgba(243,51,51,0.7)',
			'back_to_top_background_color_hover' => '#f33333',
...
if ( ! function_exists( 'lalita_get_default_fonts' ) ) {
	...
	function lalita_get_default_fonts( $filter = true ) {
		$lalita_font_defaults = array(
			...
			'font_blog_header_title' => 'Fira Sans',
			'font_blog_header_title_category' => '',
			'font_blog_header_title_variants' => '100,200,300,regular,500,600,700,800,900',
			...
			'footer_font_size' => '20',
			'font_fixed_side' => 'Roboto',
			'font_fixed_side_category' => '',
			'font_fixed_side_variants' => '100,300,regular,500,700,900',
...
define( 'LALITA_DEFAULT_FONTS' , '//fonts.googleapis.com/css?family=Fira+Sans:100,200,300,regular,500,600,700,800,900|Roboto:100,300,regular,500,700,900' );
